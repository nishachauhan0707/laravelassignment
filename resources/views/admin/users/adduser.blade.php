...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><h4>Add New User <a style="float:right;" href="{{ route('admin.users.index') }}">
                    ...
                    <form action="{{ route('admin.users.update',$user) }}" method="POST">
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="middlename" type="text" class="form-control @error('middlename') is-invalid @enderror" name="middlename" value="" required  autofocus>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('lastname') is-invalid @enderror" name="lastname" value="" required autocomplete="lastname" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="clientname" type="text" class="form-control @error('clientname') is-invalid @enderror" name="clientname" value="" required autocomplete="clientname" autofocus>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group date" data-provide="datepicker-inline">
                                    <input type="text" id="dob" name="dob"  class="form-control" value="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="pincode" type="text" class="form-control @error('pincode') is-invalid @enderror" name="pincode" value="" required autocomplete="pincode" autofocus>
